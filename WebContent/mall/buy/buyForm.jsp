	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		btn_buy.addEventListener("click", function() {
			...
			if(!form.delivery_tel.value) {
				alert('수령인 전화번호을 입력해 주세요.');
				return;
			}
			if(!form.delivery_address1.value) {
				alert('기본 주소을 입력해 주세요.');
				return;
			}
			if(!form.delivery_address2.value) {
				alert('상세 주소을 입력해 주세요.');
				return;
			}
...
if(part==1 || part==2) {
	...
	cart.setManufacturing_com(product.getManufacturing_com());
			...
			<table class="t1">
				...
				<tr>
					...
					<td width="40%" class="left">
						...
						<span class="s2"><%=cart.getManufacturing_com() %></span>
					</td>
